...
describe('resource clientCertificates', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = cloudflare.zones.clientCertificates.retrieve(
  ...
  test.skip('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.zones.clientCertificates.retrieve(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test.skip('update', async () => {
    const responsePromise = cloudflare.zones.clientCertificates.update(
      '023e105f4ecef8ad9ca31a8372d0c353',
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('update: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.zones.clientCertificates.update(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
        { path: '/_stainless_unknown_path' },
      ),
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.zones.clientCertificates.delete(
      '023e105f4ecef8ad9ca31a8372d0c353',
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('delete: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.zones.clientCertificates.delete(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
        { path: '/_stainless_unknown_path' },
      ),
  ...
  test.skip('clientCertificateForAZoneCreateClientCertificate: only required params', async () => {
    const responsePromise =
      cloudflare.zones.clientCertificates.clientCertificateForAZoneCreateClientCertificate(
        '023e105f4ecef8ad9ca31a8372d0c353',
        {
  ...
  test.skip('clientCertificateForAZoneCreateClientCertificate: required and optional params', async () => {
    const response =
      await cloudflare.zones.clientCertificates.clientCertificateForAZoneCreateClientCertificate(
        '023e105f4ecef8ad9ca31a8372d0c353',
        {
          csr: '-----BEGIN CERTIFICATE REQUEST-----\nMIICY....\n-----END CERTIFICATE REQUEST-----\n',
          validity_days: 3650,
  ...
  test.skip('clientCertificateForAZoneListClientCertificates', async () => {
    const responsePromise =
      cloudflare.zones.clientCertificates.clientCertificateForAZoneListClientCertificates(
        '023e105f4ecef8ad9ca31a8372d0c353',
      );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
