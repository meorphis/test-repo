...
describe('resource loadBalancers', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = cloudflare.zones.loadBalancers.create('699d98642c564d2e855e9661899b7252', {
      default_pools: [
  ...
  test.skip('create: required and optional params', async () => {
    const response = await cloudflare.zones.loadBalancers.create('699d98642c564d2e855e9661899b7252', {
      default_pools: [
        '17b5962d775c646f3f9725cbc7a53df4',
        '9290f38c5d07c2e2f4df57b1f61d4196',
        '00920f38ce07c2e2f4df50b1f61d4194',
  ...
  test.skip('retrieve', async () => {
    const responsePromise = cloudflare.zones.loadBalancers.retrieve(
  ...
  test.skip('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.zones.loadBalancers.retrieve(
        '699d98642c564d2e855e9661899b7252',
        '699d98642c564d2e855e9661899b7252',
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = cloudflare.zones.loadBalancers.update(
      '699d98642c564d2e855e9661899b7252',
      '699d98642c564d2e855e9661899b7252',
      {
        default_pools: [
  ...
  test.skip('update: required and optional params', async () => {
    const response = await cloudflare.zones.loadBalancers.update(
      '699d98642c564d2e855e9661899b7252',
      '699d98642c564d2e855e9661899b7252',
      {
        default_pools: [
  ...
  test.skip('list', async () => {
    const responsePromise = cloudflare.zones.loadBalancers.list('699d98642c564d2e855e9661899b7252');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.zones.loadBalancers.list('699d98642c564d2e855e9661899b7252', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(Cloudflare.NotFoundError);
  });
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.zones.loadBalancers.delete(
      '699d98642c564d2e855e9661899b7252',
      '699d98642c564d2e855e9661899b7252',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('patch', async () => {
    const responsePromise = cloudflare.zones.loadBalancers.patch(
      '699d98642c564d2e855e9661899b7252',
      '699d98642c564d2e855e9661899b7252',
      {},
    );
