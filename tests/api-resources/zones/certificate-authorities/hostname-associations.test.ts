...
describe('resource hostnameAssociations', () => {
  ...
  test.skip('clientCertificateForAZoneListHostnameAssociations', async () => {
    const responsePromise =
      cloudflare.zones.certificateAuthorities.hostnameAssociations.clientCertificateForAZoneListHostnameAssociations(
  ...
  test.skip('clientCertificateForAZonePutHostnameAssociations', async () => {
    const responsePromise =
      cloudflare.zones.certificateAuthorities.hostnameAssociations.clientCertificateForAZonePutHostnameAssociations(
        '023e105f4ecef8ad9ca31a8372d0c353',
        {},
      );
    const rawResponse = await responsePromise.asResponse();
