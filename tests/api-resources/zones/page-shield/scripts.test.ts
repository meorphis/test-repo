...
describe('resource scripts', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = cloudflare.zones.pageShield.scripts.retrieve(
  ...
  test.skip('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.zones.pageShield.scripts.retrieve(
        '023e105f4ecef8ad9ca31a8372d0c353',
        'c9ef84a6bf5e47138c75d95e2f933e8f',
  ...
  test.skip('pageShieldListPageShieldScripts', async () => {
    const responsePromise = cloudflare.zones.pageShield.scripts.pageShieldListPageShieldScripts(
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('pageShieldListPageShieldScripts: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.zones.pageShield.scripts.pageShieldListPageShieldScripts(
        '023e105f4ecef8ad9ca31a8372d0c353',
        { path: '/_stainless_unknown_path' },
      ),
    ).rejects.toThrow(Cloudflare.NotFoundError);
