...
describe('resource imports', () => {
  ...
  test.skip('dnsRecordsForAZoneImportDNSRecords: only required params', async () => {
    const responsePromise = cloudflare.zones.dnsRecords.imports.dnsRecordsForAZoneImportDNSRecords(
  ...
  test.skip('dnsRecordsForAZoneImportDNSRecords: required and optional params', async () => {
    const response = await cloudflare.zones.dnsRecords.imports.dnsRecordsForAZoneImportDNSRecords(
      '023e105f4ecef8ad9ca31a8372d0c353',
