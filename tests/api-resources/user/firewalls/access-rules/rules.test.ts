...
describe('resource rules', () => {
  ...
  test.skip('update', async () => {
    const responsePromise = cloudflare.user.firewalls.accessRules.rules.update(
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.user.firewalls.accessRules.rules.delete(
      '92f17202ed8bd63d69a66b86a49a8f6b',
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('ipAccessRulesForAUserCreateAnIPAccessRule: only required params', async () => {
    const responsePromise =
      cloudflare.user.firewalls.accessRules.rules.ipAccessRulesForAUserCreateAnIPAccessRule({
        configuration: {},
        mode: 'challenge',
      });
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('ipAccessRulesForAUserCreateAnIPAccessRule: required and optional params', async () => {
    const response =
      await cloudflare.user.firewalls.accessRules.rules.ipAccessRulesForAUserCreateAnIPAccessRule({
  ...
  test.skip('ipAccessRulesForAUserListIPAccessRules', async () => {
    const responsePromise =
      cloudflare.user.firewalls.accessRules.rules.ipAccessRulesForAUserListIPAccessRules();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
