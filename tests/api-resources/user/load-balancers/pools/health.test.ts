...
describe('resource health', () => {
  ...
  test.skip('loadBalancerPoolsPoolHealthDetails', async () => {
    const responsePromise = cloudflare.user.loadBalancers.pools.health.loadBalancerPoolsPoolHealthDetails(
  ...
  test.skip('loadBalancerPoolsPoolHealthDetails: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.user.loadBalancers.pools.health.loadBalancerPoolsPoolHealthDetails(
        '17b5962d775c646f3f9725cbc7a53df4',
