...
describe('resource excludes', () => {
  ...
  test.skip('devicesGetSplitTunnelExcludeList', async () => {
    const responsePromise = cloudflare.accounts.devices.policies.excludes.devicesGetSplitTunnelExcludeList(
  ...
  test.skip('devicesGetSplitTunnelExcludeList: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.accounts.devices.policies.excludes.devicesGetSplitTunnelExcludeList(
        '699d98642c564d2e855e9661899b7252',
  ...
  test.skip('devicesGetSplitTunnelExcludeListForADeviceSettingsPolicy', async () => {
    const responsePromise =
      cloudflare.accounts.devices.policies.excludes.devicesGetSplitTunnelExcludeListForADeviceSettingsPolicy(
        '699d98642c564d2e855e9661899b7252',
  ...
  test.skip('devicesSetSplitTunnelExcludeList: only required params', async () => {
    const responsePromise = cloudflare.accounts.devices.policies.excludes.devicesSetSplitTunnelExcludeList(
      '699d98642c564d2e855e9661899b7252',
      [
  ...
  test.skip('devicesSetSplitTunnelExcludeList: required and optional params', async () => {
    const response = await cloudflare.accounts.devices.policies.excludes.devicesSetSplitTunnelExcludeList(
      '699d98642c564d2e855e9661899b7252',
      [
        {
  ...
  test.skip('devicesSetSplitTunnelExcludeListForADeviceSettingsPolicy: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.devices.policies.excludes.devicesSetSplitTunnelExcludeListForADeviceSettingsPolicy(
        '699d98642c564d2e855e9661899b7252',
        'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
        [
          { address: '192.0.2.0/24', description: 'Exclude testing domains from the tunnel' },
  ...
  test.skip('devicesSetSplitTunnelExcludeListForADeviceSettingsPolicy: required and optional params', async () => {
    const response =
      await cloudflare.accounts.devices.policies.excludes.devicesSetSplitTunnelExcludeListForADeviceSettingsPolicy(
        '699d98642c564d2e855e9661899b7252',
        'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
        [
          {
