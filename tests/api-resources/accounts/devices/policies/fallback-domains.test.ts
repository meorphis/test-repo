...
describe('resource fallbackDomains', () => {
  ...
  test.skip('devicesGetLocalDomainFallbackList', async () => {
    const responsePromise =
      cloudflare.accounts.devices.policies.fallbackDomains.devicesGetLocalDomainFallbackList(
  ...
  test.skip('devicesGetLocalDomainFallbackListForADeviceSettingsPolicy', async () => {
    const responsePromise =
      cloudflare.accounts.devices.policies.fallbackDomains.devicesGetLocalDomainFallbackListForADeviceSettingsPolicy(
        '699d98642c564d2e855e9661899b7252',
  ...
  test.skip('devicesSetLocalDomainFallbackList: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.devices.policies.fallbackDomains.devicesSetLocalDomainFallbackList(
        '699d98642c564d2e855e9661899b7252',
  ...
  test.skip('devicesSetLocalDomainFallbackList: required and optional params', async () => {
    const response =
      await cloudflare.accounts.devices.policies.fallbackDomains.devicesSetLocalDomainFallbackList(
        '699d98642c564d2e855e9661899b7252',
        [
          {
  ...
  test.skip('devicesSetLocalDomainFallbackListForADeviceSettingsPolicy: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.devices.policies.fallbackDomains.devicesSetLocalDomainFallbackListForADeviceSettingsPolicy(
        '699d98642c564d2e855e9661899b7252',
        'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
        [{ suffix: 'example.com' }, { suffix: 'example.com' }, { suffix: 'example.com' }],
      );
  ...
  test.skip('devicesSetLocalDomainFallbackListForADeviceSettingsPolicy: required and optional params', async () => {
    const response =
      await cloudflare.accounts.devices.policies.fallbackDomains.devicesSetLocalDomainFallbackListForADeviceSettingsPolicy(
        '699d98642c564d2e855e9661899b7252',
        'f174e90a-fafe-4643-bbbc-4a0ed4fc8415',
        [
          {
