...
describe('resource settings', () => {
  ...
  test.skip('zeroTrustAccountsGetDeviceSettingsForZeroTrustAccount', async () => {
    const responsePromise =
      cloudflare.accounts.devices.settings.zeroTrustAccountsGetDeviceSettingsForZeroTrustAccount(
  ...
  test.skip('zeroTrustAccountsUpdateDeviceSettingsForTheZeroTrustAccount', async () => {
    const responsePromise =
      cloudflare.accounts.devices.settings.zeroTrustAccountsUpdateDeviceSettingsForTheZeroTrustAccount(
        '699d98642c564d2e855e9661899b7252',
        {},
      );
    const rawResponse = await responsePromise.asResponse();
