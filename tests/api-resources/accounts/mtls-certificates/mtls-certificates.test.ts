...
describe('resource mtlsCertificates', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = cloudflare.accounts.mtlsCertificates.retrieve(
  ...
  test.skip('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.accounts.mtlsCertificates.retrieve(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.accounts.mtlsCertificates.delete(
      '023e105f4ecef8ad9ca31a8372d0c353',
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  // skipped: tests are disabled for the time being
  test.skip('mTlsCertificateManagementListMTlsCertificates', async () => {
    const responsePromise =
      cloudflare.accounts.mtlsCertificates.mTlsCertificateManagementListMTlsCertificates(
        '023e105f4ecef8ad9ca31a8372d0c353',
      );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  // skipped: tests are disabled for the time being
  test.skip('mTlsCertificateManagementListMTlsCertificates: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.accounts.mtlsCertificates.mTlsCertificateManagementListMTlsCertificates(
        '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  // skipped: tests are disabled for the time being
  test.skip('mTlsCertificateManagementUploadMTlsCertificate: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.mtlsCertificates.mTlsCertificateManagementUploadMTlsCertificate(
        '023e105f4ecef8ad9ca31a8372d0c353',
        {
          ca: true,
          certificates:
  ...
  // skipped: tests are disabled for the time being
  test.skip('mTlsCertificateManagementUploadMTlsCertificate: required and optional params', async () => {
    const response =
      await cloudflare.accounts.mtlsCertificates.mTlsCertificateManagementUploadMTlsCertificate(
        '023e105f4ecef8ad9ca31a8372d0c353',
        {
          ca: true,
          certificates:
