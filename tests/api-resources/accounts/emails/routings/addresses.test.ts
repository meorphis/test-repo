...
describe('resource addresses', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = cloudflare.accounts.emails.routings.addresses.retrieve(
  ...
  test.skip('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.accounts.emails.routings.addresses.retrieve(
        '023e105f4ecef8ad9ca31a8372d0c353',
        'ea95132c15732412d22c1476fa83f27a',
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.accounts.emails.routings.addresses.delete(
      '023e105f4ecef8ad9ca31a8372d0c353',
      'ea95132c15732412d22c1476fa83f27a',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('emailRoutingDestinationAddressesCreateADestinationAddress: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.emails.routings.addresses.emailRoutingDestinationAddressesCreateADestinationAddress(
        '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test.skip('emailRoutingDestinationAddressesCreateADestinationAddress: required and optional params', async () => {
    const response =
      await cloudflare.accounts.emails.routings.addresses.emailRoutingDestinationAddressesCreateADestinationAddress(
        '023e105f4ecef8ad9ca31a8372d0c353',
        { email: 'user@example.com' },
      );
  });
  ...
  test.skip('emailRoutingDestinationAddressesListDestinationAddresses', async () => {
    const responsePromise =
      cloudflare.accounts.emails.routings.addresses.emailRoutingDestinationAddressesListDestinationAddresses(
        '023e105f4ecef8ad9ca31a8372d0c353',
      );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
