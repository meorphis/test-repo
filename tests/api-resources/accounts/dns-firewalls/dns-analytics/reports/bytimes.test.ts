...
describe('resource bytimes', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = cloudflare.accounts.dnsFirewalls.dnsAnalytics.reports.bytimes.list(
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.accounts.dnsFirewalls.dnsAnalytics.reports.bytimes.list(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
