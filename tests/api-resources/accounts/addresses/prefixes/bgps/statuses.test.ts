...
describe('resource statuses', () => {
  ...
  test.skip('ipAddressManagementDynamicAdvertisementGetAdvertisementStatus', async () => {
    const responsePromise =
      cloudflare.accounts.addresses.prefixes.bgps.statuses.ipAddressManagementDynamicAdvertisementGetAdvertisementStatus(
  ...
  test.skip('ipAddressManagementDynamicAdvertisementUpdatePrefixDynamicAdvertisementStatus: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.addresses.prefixes.bgps.statuses.ipAddressManagementDynamicAdvertisementUpdatePrefixDynamicAdvertisementStatus(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
        { advertised: true },
      );
  ...
  test.skip('ipAddressManagementDynamicAdvertisementUpdatePrefixDynamicAdvertisementStatus: required and optional params', async () => {
    const response =
      await cloudflare.accounts.addresses.prefixes.bgps.statuses.ipAddressManagementDynamicAdvertisementUpdatePrefixDynamicAdvertisementStatus(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
        { advertised: true },
      );
