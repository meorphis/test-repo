...
describe('resource delegations', () => {
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.accounts.addresses.prefixes.delegations.delete(
  ...
  test.skip('ipAddressManagementPrefixDelegationCreatePrefixDelegation: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.addresses.prefixes.delegations.ipAddressManagementPrefixDelegationCreatePrefixDelegation(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
  ...
  test.skip('ipAddressManagementPrefixDelegationCreatePrefixDelegation: required and optional params', async () => {
    const response =
      await cloudflare.accounts.addresses.prefixes.delegations.ipAddressManagementPrefixDelegationCreatePrefixDelegation(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
        { cidr: '192.0.2.0/24', delegated_account_id: 'b1946ac92492d2347c6235b4d2611184' },
      );
  ...
  test.skip('ipAddressManagementPrefixDelegationListPrefixDelegations', async () => {
    const responsePromise =
      cloudflare.accounts.addresses.prefixes.delegations.ipAddressManagementPrefixDelegationListPrefixDelegations(
        '023e105f4ecef8ad9ca31a8372d0c353',
        '023e105f4ecef8ad9ca31a8372d0c353',
      );
    const rawResponse = await responsePromise.asResponse();
