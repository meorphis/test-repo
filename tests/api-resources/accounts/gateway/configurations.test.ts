...
describe('resource configurations', () => {
  ...
  test.skip('zeroTrustAccountsGetZeroTrustAccountConfiguration', async () => {
    const responsePromise =
      cloudflare.accounts.gateway.configurations.zeroTrustAccountsGetZeroTrustAccountConfiguration(
  ...
  test.skip('zeroTrustAccountsPatchZeroTrustAccountConfiguration', async () => {
    const responsePromise =
      cloudflare.accounts.gateway.configurations.zeroTrustAccountsPatchZeroTrustAccountConfiguration(
        '699d98642c564d2e855e9661899b7252',
        {},
      );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('zeroTrustAccountsUpdateZeroTrustAccountConfiguration', async () => {
    const responsePromise =
      cloudflare.accounts.gateway.configurations.zeroTrustAccountsUpdateZeroTrustAccountConfiguration(
        '699d98642c564d2e855e9661899b7252',
        {},
      );
    const rawResponse = await responsePromise.asResponse();
