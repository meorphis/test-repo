...
describe('resource virtualNetworks', () => {
  ...
  test.skip('update', async () => {
    const responsePromise = cloudflare.accounts.teamnet.virtualNetworks.update(
  ...
  test.skip('delete', async () => {
    const responsePromise = cloudflare.accounts.teamnet.virtualNetworks.delete(
      '699d98642c564d2e855e9661899b7252',
      'f70ff985-a4ef-4643-bbbc-4a0ed4fc8415',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('tunnelVirtualNetworkCreateAVirtualNetwork: only required params', async () => {
    const responsePromise =
      cloudflare.accounts.teamnet.virtualNetworks.tunnelVirtualNetworkCreateAVirtualNetwork(
        '699d98642c564d2e855e9661899b7252',
        { name: 'us-east-1-vpc' },
      );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('tunnelVirtualNetworkCreateAVirtualNetwork: required and optional params', async () => {
    const response =
      await cloudflare.accounts.teamnet.virtualNetworks.tunnelVirtualNetworkCreateAVirtualNetwork(
        '699d98642c564d2e855e9661899b7252',
  ...
  test.skip('tunnelVirtualNetworkListVirtualNetworks', async () => {
    const responsePromise =
      cloudflare.accounts.teamnet.virtualNetworks.tunnelVirtualNetworkListVirtualNetworks(
        '699d98642c564d2e855e9661899b7252',
      );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
