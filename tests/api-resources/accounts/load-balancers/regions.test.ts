...
describe('resource regions', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = cloudflare.accounts.loadBalancers.regions.retrieve(
  ...
  test.skip('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.accounts.loadBalancers.regions.retrieve('023e105f4ecef8ad9ca31a8372d0c353', 'WNAM', {
  ...
  test.skip('loadBalancerRegionsListRegions', async () => {
    const responsePromise = cloudflare.accounts.loadBalancers.regions.loadBalancerRegionsListRegions(
      '023e105f4ecef8ad9ca31a8372d0c353',
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('loadBalancerRegionsListRegions: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.accounts.loadBalancers.regions.loadBalancerRegionsListRegions(
        '023e105f4ecef8ad9ca31a8372d0c353',
        { path: '/_stainless_unknown_path' },
      ),
    ).rejects.toThrow(Cloudflare.NotFoundError);
