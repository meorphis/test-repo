...
describe('resource locations', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = cloudflare.radar.http.tops.locations.list();
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      cloudflare.radar.http.tops.locations.list({ path: '/_stainless_unknown_path' }),
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.radar.http.tops.locations.list(
        {
