...
describe('resource indicatorFeeds', () => {
  ...
  test.skip('create', async () => {
    const responsePromise = cloudflare.intel.indicatorFeeds.create('023e105f4ecef8ad9ca31a8372d0c353', {});
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      cloudflare.intel.indicatorFeeds.list('023e105f4ecef8ad9ca31a8372d0c353', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(Cloudflare.NotFoundError);
  });
  ...
  test.skip('data', async () => {
    const responsePromise = cloudflare.intel.indicatorFeeds.data('023e105f4ecef8ad9ca31a8372d0c353', 12);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // skipped: tests are disabled for the time being
  test.skip('data: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
  ...
  test.skip('snapshot', async () => {
    const responsePromise = cloudflare.intel.indicatorFeeds.snapshot(
