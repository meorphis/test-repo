...
import * as HealthchecksAPI from 'cloudflare/resources/healthchecks';
import * as HealthchecksHealthchecksAPI from 'cloudflare/resources/zones/healthchecks/healthchecks';
...
export class Healthchecks extends APIResource {
  ...
  ): Core.APIPromise<HealthchecksHealthchecksAPI.HealthchecksSingleResponse> {
    return this._client.patch(`/zones/${zoneIdentifier}/healthchecks/${identifier}`, { body, ...options });
  }
}
