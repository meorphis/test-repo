...
export class Copies extends APIResource {
  ...
  streamVideosUploadVideosFromAURL(
    ...
    return this._client.post(`/accounts/${accountIdentifier}/stream/copy`, {
      body,
      ...options,
      headers: {
...
export interface CopyStreamVideosUploadVideosFromAURLResponse {
  errors?: Array<CopyStreamVideosUploadVideosFromAURLResponse.Error>;

  messages?: Array<CopyStreamVideosUploadVideosFromAURLResponse.Message>;

  result?: CopyStreamVideosUploadVideosFromAURLResponse.Result;
