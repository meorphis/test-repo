...
export class Tokens extends APIResource {
  ...
  streamVideosCreateSignedURLTokensForVideos(
    ...
    return this._client.post(`/accounts/${accountIdentifier}/stream/${identifier}/token`, {
      body,
      ...options,
    });
  }
...
export interface TokenStreamVideosCreateSignedURLTokensForVideosResponse {
  errors?: Array<TokenStreamVideosCreateSignedURLTokensForVideosResponse.Error>;

  messages?: Array<TokenStreamVideosCreateSignedURLTokensForVideosResponse.Message>;

  result?: TokenStreamVideosCreateSignedURLTokensForVideosResponse.Result;
...
export namespace TokenStreamVideosCreateSignedURLTokensForVideosResponse {
