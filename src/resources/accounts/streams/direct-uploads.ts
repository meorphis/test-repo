...
export class DirectUploads extends APIResource {
  ...
  streamVideosUploadVideosViaDirectUploadURLs(
    ...
    return this._client.post(`/accounts/${accountIdentifier}/stream/direct_upload`, {
      body,
      ...options,
...
export interface DirectUploadStreamVideosUploadVideosViaDirectUploadURLsResponse {
  errors?: Array<DirectUploadStreamVideosUploadVideosViaDirectUploadURLsResponse.Error>;

  messages?: Array<DirectUploadStreamVideosUploadVideosViaDirectUploadURLsResponse.Message>;

  result?: DirectUploadStreamVideosUploadVideosViaDirectUploadURLsResponse.Result;
