...
export class Clips extends APIResource {
  ...
  streamVideoClippingClipVideosGivenAStartAndEndTime(
    ...
    return this._client.post(`/accounts/${accountIdentifier}/stream/clip`, { body, ...options });
  }
}

export interface ClipStreamVideoClippingClipVideosGivenAStartAndEndTimeResponse {
  errors?: Array<ClipStreamVideoClippingClipVideosGivenAStartAndEndTimeResponse.Error>;

  messages?: Array<ClipStreamVideoClippingClipVideosGivenAStartAndEndTimeResponse.Message>;

  result?: ClipStreamVideoClippingClipVideosGivenAStartAndEndTimeResponse.Result;
