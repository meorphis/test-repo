...
import * as PhasesAPI from 'cloudflare/resources/accounts/rulesets/phases/phases';
...
export class Rulesets extends APIResource {
  ...
  retrieve(
    ...
    return this._client.get(`/accounts/${accountId}/rulesets/${rulesetId}`, options);
  }
  ...
  update(
    ...
    return this._client.put(`/accounts/${accountId}/rulesets/${rulesetId}`, { body, ...options });
  }

  /**
   * Deletes all versions of an existing account ruleset.
   */
  delete(accountId: string, rulesetId: string, options?: Core.RequestOptions): Core.APIPromise<void> {
    return this._client.delete(`/accounts/${accountId}/rulesets/${rulesetId}`, {
      ...options,
  ...
  accountRulesetsCreateAnAccountRuleset(
    accountId: string,
    body: RulesetAccountRulesetsCreateAnAccountRulesetParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<RulesetAccountRulesetsCreateAnAccountRulesetResponse> {
    return this._client.post(`/accounts/${accountId}/rulesets`, { body, ...options });
  }
  ...
  accountRulesetsListAccountRulesets(
    accountId: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<RulesetAccountRulesetsListAccountRulesetsResponse> {
    return this._client.get(`/accounts/${accountId}/rulesets`, options);
  }
}
...
export interface RulesetAccountRulesetsCreateAnAccountRulesetResponse {
  errors?: unknown;

  /**
   * A list of warning messages.
   */
  messages?: Array<RulesetAccountRulesetsCreateAnAccountRulesetResponse.Message>;

  result?: RulesetAccountRulesetsCreateAnAccountRulesetResponse.Result;
...
export namespace RulesetAccountRulesetsCreateAnAccountRulesetResponse {
  /**
   * A message.
   */
  export interface Message {
...
export interface RulesetAccountRulesetsListAccountRulesetsResponse {
  errors?: unknown;

  /**
   * A list of warning messages.
   */
  messages?: Array<RulesetAccountRulesetsListAccountRulesetsResponse.Message>;

  /**
   * A list of rulesets. The returned information will not include the rules in each
   * ruleset.
   */
  result?: Array<RulesetAccountRulesetsListAccountRulesetsResponse.Result>;
...
export namespace RulesetAccountRulesetsListAccountRulesetsResponse {
  /**
   * A message.
   */
  export interface Message {
...
export interface RulesetAccountRulesetsCreateAnAccountRulesetParams {
  id?: unknown;
   ...
   */
  rules?: Array<
    | RulesetAccountRulesetsCreateAnAccountRulesetParams.OexZd8xKBlockRule
    | RulesetAccountRulesetsCreateAnAccountRulesetParams.OexZd8xKExecuteRule
    | RulesetAccountRulesetsCreateAnAccountRulesetParams.OexZd8xKLogRule
    | RulesetAccountRulesetsCreateAnAccountRulesetParams.OexZd8xKSkipRule
  >;
}

export namespace RulesetAccountRulesetsCreateAnAccountRulesetParams {
  export interface OexZd8xKBlockRule {
    /**
     * The unique ID of the rule.
     */
