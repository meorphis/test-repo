...
export class Versions extends APIResource {
  ...
  accountRulesetsListAnAccountEntryPointRulesetSVersions(
    ...
    rulesetPhase:
      ...
      | 'magic_transit_managed',
    options?: Core.RequestOptions,
  ): Core.APIPromise<VersionAccountRulesetsListAnAccountEntryPointRulesetSVersionsResponse> {
    return this._client.get(
      `/accounts/${accountId}/rulesets/phases/${rulesetPhase}/entrypoint/versions`,
      options,
    );
  }
}
...
export interface VersionAccountRulesetsListAnAccountEntryPointRulesetSVersionsResponse {
  errors?: unknown;

  /**
   * A list of warning messages.
   */
  messages?: Array<VersionAccountRulesetsListAnAccountEntryPointRulesetSVersionsResponse.Message>;

  /**
   * A list of rulesets. The returned information will not include the rules in each
   * ruleset.
   */
  result?: Array<VersionAccountRulesetsListAnAccountEntryPointRulesetSVersionsResponse.Result>;
...
export namespace VersionAccountRulesetsListAnAccountEntryPointRulesetSVersionsResponse {
  /**
   * A message.
   */
  export interface Message {
