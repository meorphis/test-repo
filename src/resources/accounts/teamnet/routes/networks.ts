...
export class Networks extends APIResource {
  ...
  update(
    ...
    return this._client.post(`/accounts/${accountIdentifier}/teamnet/routes/network/${ipNetworkEncoded}`, {
      body,
      ...options,
    });
  }
  ...
  delete(
    ...
    if (isRequestOptions(params)) {
      return this.delete(accountIdentifier, ipNetworkEncoded, {}, params);
    }
    const { tun_type } = params;
    return this._client.delete(`/accounts/${accountIdentifier}/teamnet/routes/network/${ipNetworkEncoded}`, {
      query: { tun_type },
      ...options,
    });
  }
...
export interface NetworkDeleteResponse {
  ...
  result?: NetworkDeleteResponse.Result;
