...
export class Configurations extends APIResource {
  ...
  ): Core.APIPromise<ConfigurationCloudflareTunnelConfigurationGetConfigurationResponse> {
    return this._client.get(`/accounts/${accountIdentifier}/cfd_tunnel/${tunnelId}/configurations`, options);
  }
  ...
  cloudflareTunnelConfigurationPutConfiguration(
    accountIdentifier: string,
    tunnelId: string,
    body: ConfigurationCloudflareTunnelConfigurationPutConfigurationParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ConfigurationCloudflareTunnelConfigurationPutConfigurationResponse> {
    return this._client.put(`/accounts/${accountIdentifier}/cfd_tunnel/${tunnelId}/configurations`, {
      body,
      ...options,
    });
  }
...
export interface ConfigurationCloudflareTunnelConfigurationGetConfigurationResponse {
  errors?: Array<ConfigurationCloudflareTunnelConfigurationGetConfigurationResponse.Error>;

  messages?: Array<ConfigurationCloudflareTunnelConfigurationGetConfigurationResponse.Message>;
...
export namespace ConfigurationCloudflareTunnelConfigurationGetConfigurationResponse {
...
export interface ConfigurationCloudflareTunnelConfigurationPutConfigurationResponse {
  errors?: Array<ConfigurationCloudflareTunnelConfigurationPutConfigurationResponse.Error>;

  messages?: Array<ConfigurationCloudflareTunnelConfigurationPutConfigurationResponse.Message>;
...
export namespace ConfigurationCloudflareTunnelConfigurationPutConfigurationResponse {
  export interface Error {
    code: number;
...
export interface ConfigurationCloudflareTunnelConfigurationPutConfigurationParams {
  /**
   * The tunnel configuration and ingress rules.
   */
  config?: ConfigurationCloudflareTunnelConfigurationPutConfigurationParams.Config;
}

export namespace ConfigurationCloudflareTunnelConfigurationPutConfigurationParams {
  /**
   * The tunnel configuration and ingress rules.
   */
