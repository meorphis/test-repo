...
export class Bulks extends APIResource {
  ...
  delete(
    ...
    return this._client.delete(
      `/accounts/${accountIdentifier}/storage/kv/namespaces/${namespaceIdentifier}/bulk`,
      { body, ...options },
    );
  }
...
export interface BulkDeleteResponse {
  errors?: Array<BulkDeleteResponse.Error>;

  messages?: Array<BulkDeleteResponse.Message>;
...
export interface BulkWorkersKvNamespaceWriteMultipleKeyValuePairsResponse {
  errors?: Array<BulkWorkersKvNamespaceWriteMultipleKeyValuePairsResponse.Error>;

  messages?: Array<BulkWorkersKvNamespaceWriteMultipleKeyValuePairsResponse.Message>;
...
export namespace BulkWorkersKvNamespaceWriteMultipleKeyValuePairsResponse {
  export interface Error {
    code: number;
