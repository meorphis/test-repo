...
export class Scan extends APIResource {
  ...
  create(
    ...
    return this._client.post(`/accounts/${accountId}/urlscanner/scan`, { body, ...options });
  }
  ...
  retrieve(
    ...
    return this._client.get(`/accounts/${accountId}/urlscanner/scan/${scanId}`, options);
  }
  ...
  list(
    ...
    return this._client.get(`/accounts/${accountId}/urlscanner/scan`, { query, ...options });
  }
}

export interface ScanCreateResponse {
  errors: Array<ScanCreateResponse.Error>;

  messages: Array<ScanCreateResponse.Message>;

  result: ScanCreateResponse.Result;
...
export interface ScanRetrieveResponse {
  errors: Array<ScanRetrieveResponse.Error>;

  messages: Array<ScanRetrieveResponse.Message>;

  result: ScanRetrieveResponse.Result;
...
export interface ScanListResponse {
  errors: Array<ScanListResponse.Error>;

  messages: Array<ScanListResponse.Message>;

  result: ScanListResponse.Result;
