...
import * as ContentAPI from 'cloudflare/resources/accounts/workers/dispatch/namespaces/scripts/content';
import * as SettingsAPI from 'cloudflare/resources/accounts/workers/dispatch/namespaces/scripts/settings';
...
export class Scripts extends APIResource {
  ...
  create(
    ...
    return this._client.put(
      `/accounts/${accountIdentifier}/workers/dispatch/namespaces/${dispatchNamespace}/scripts/${scriptName}`,
...
export interface ScriptCreateResponse {
  errors?: Array<ScriptCreateResponse.Error>;

  messages?: Array<ScriptCreateResponse.Message>;

  result?: ScriptCreateResponse.Result;
...
export namespace ScriptCreateResponse {
...
export type ScriptCreateParams = ScriptCreateParams.Variant0 | ScriptCreateParams.Variant1;

export namespace ScriptCreateParams {
  export interface Variant0 {
     ...
     */
    metadata?: ScriptCreateParams.Variant0.Metadata;
  }
