...
export class Settings extends APIResource {
  ...
  retrieve(
    ...
    return this._client.get(`/accounts/${accountIdentifier}/workers/scripts/${scriptName}/settings`, options);
  }
  ...
  update(
    ...
    return this._client.patch(
      `/accounts/${accountIdentifier}/workers/scripts/${scriptName}/settings`,
...
export namespace SettingUpdateParams {
  export interface Settings {
     ...
     */
    bindings?: Array<
      | Settings.AvYbsl2uKvNamespaceBinding
      | Settings.AvYbsl2uServiceBinding
      | Settings.AvYbsl2uDoBinding
      | Settings.AvYbsl2uR2Binding
      | Settings.AvYbsl2uQueueBinding
      | Settings.AvYbsl2uD1Binding
      | Settings.AvYbsl2uDispatchNamespaceBinding
      | Settings.AvYbsl2uMtlsCertBinding
    >;
     ...
     * Migrations to apply for Durable Objects associated with this Worker.
     */
    migrations?: Settings.AvYbsl2uSingleStepMigrations | Settings.AvYbsl2uSteppedMigrations;
