...
export class Jobs extends APIResource {
  ...
  ): Core.APIPromise<JobGetAccountsAccountIdentifierLogpushDatasetsDatasetJobsResponse> {
    return this._client.get(`/accounts/${accountIdentifier}/logpush/datasets/${dataset}/jobs`, options);
  }
}

export interface JobGetAccountsAccountIdentifierLogpushDatasetsDatasetJobsResponse {
  errors?: Array<JobGetAccountsAccountIdentifierLogpushDatasetsDatasetJobsResponse.Error>;

  messages?: Array<JobGetAccountsAccountIdentifierLogpushDatasetsDatasetJobsResponse.Message>;

  result?: Array<JobGetAccountsAccountIdentifierLogpushDatasetsDatasetJobsResponse.Result | null>;
...
export namespace JobGetAccountsAccountIdentifierLogpushDatasetsDatasetJobsResponse {
