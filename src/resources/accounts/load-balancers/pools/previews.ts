...
export class Previews extends APIResource {
  ...
  accountLoadBalancerPoolsPreviewPool(
    ...
    return this._client.post(`/accounts/${accountIdentifier}/load_balancers/pools/${identifier}/preview`, {
      body,
      ...options,
    });
  }
...
export interface PreviewAccountLoadBalancerPoolsPreviewPoolResponse {
  errors?: Array<PreviewAccountLoadBalancerPoolsPreviewPoolResponse.Error>;

  messages?: Array<PreviewAccountLoadBalancerPoolsPreviewPoolResponse.Message>;

  result?: PreviewAccountLoadBalancerPoolsPreviewPoolResponse.Result;
...
export namespace PreviewAccountLoadBalancerPoolsPreviewPoolResponse {
