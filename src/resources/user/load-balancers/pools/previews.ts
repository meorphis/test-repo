...
export class Previews extends APIResource {
  ...
  loadBalancerPoolsPreviewPool(
    ...
    return this._client.post(`/user/load_balancers/pools/${identifier}/preview`, { body, ...options });
  }
}

export interface PreviewLoadBalancerPoolsPreviewPoolResponse {
  errors?: Array<PreviewLoadBalancerPoolsPreviewPoolResponse.Error>;

  messages?: Array<PreviewLoadBalancerPoolsPreviewPoolResponse.Message>;

  result?: PreviewLoadBalancerPoolsPreviewPoolResponse.Result;
...
export namespace PreviewLoadBalancerPoolsPreviewPoolResponse {
