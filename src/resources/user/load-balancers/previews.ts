...
export class Previews extends APIResource {
   ...
   */
  retrieve(previewId: unknown, options?: Core.RequestOptions): Core.APIPromise<PreviewRetrieveResponse> {
    return this._client.get(`/user/load_balancers/preview/${previewId}`, options);
  }
}
