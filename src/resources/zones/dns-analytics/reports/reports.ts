...
import * as ReportsAPI from 'cloudflare/resources/zones/dns-analytics/reports/reports';
...
export class Reports extends APIResource {
  ...
  list(
    ...
    return this._client.get(`/zones/${identifier}/dns_analytics/report`, { query, ...options });
  }
}
