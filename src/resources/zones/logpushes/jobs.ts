...
export class Jobs extends APIResource {
  ...
  retrieve(
    ...
    return this._client.get(`/zones/${zoneIdentifier}/logpush/jobs/${jobIdentifier}`, options);
  }
  ...
  update(
    ...
    return this._client.put(`/zones/${zoneIdentifier}/logpush/jobs/${jobIdentifier}`, { body, ...options });
  }
  ...
  delete(
    ...
    return this._client.delete(`/zones/${zoneIdentifier}/logpush/jobs/${jobIdentifier}`, options);
  }
  ...
  getZonesZoneIdentifierLogpushJobs(
    zoneIdentifier: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<JobGetZonesZoneIdentifierLogpushJobsResponse> {
    return this._client.get(`/zones/${zoneIdentifier}/logpush/jobs`, options);
  }
  ...
  postZonesZoneIdentifierLogpushJobs(
    zoneIdentifier: string,
    body: JobPostZonesZoneIdentifierLogpushJobsParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<JobPostZonesZoneIdentifierLogpushJobsResponse> {
    return this._client.post(`/zones/${zoneIdentifier}/logpush/jobs`, { body, ...options });
  }
}
...
export interface JobGetZonesZoneIdentifierLogpushJobsResponse {
  errors?: Array<JobGetZonesZoneIdentifierLogpushJobsResponse.Error>;

  messages?: Array<JobGetZonesZoneIdentifierLogpushJobsResponse.Message>;

  result?: Array<JobGetZonesZoneIdentifierLogpushJobsResponse.Result | null>;
...
export namespace JobGetZonesZoneIdentifierLogpushJobsResponse {
  export interface Error {
    code: number;
...
export interface JobPostZonesZoneIdentifierLogpushJobsResponse {
  errors?: Array<JobPostZonesZoneIdentifierLogpushJobsResponse.Error>;

  messages?: Array<JobPostZonesZoneIdentifierLogpushJobsResponse.Message>;

  result?: JobPostZonesZoneIdentifierLogpushJobsResponse.Result | null;
...
export namespace JobPostZonesZoneIdentifierLogpushJobsResponse {
  export interface Error {
    code: number;
...
export interface JobPostZonesZoneIdentifierLogpushJobsParams {
  /**
   * Uniquely identifies a resource (such as an s3 bucket) where data will be pushed.
   * Additional configuration parameters supported by the destination may be
   * included.
