...
import * as ColoAPI from 'cloudflare/resources/zones/analytics/colo';
...
export class Colo extends APIResource {
  ...
  zoneAnalyticsDeprecatedGetAnalyticsByCoLocations(
    ...
    return this._client.get(`/zones/${zoneIdentifier}/analytics/colos`, { query, ...options });
  }
}

export interface ColoZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse {
  errors?: Array<ColoZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse.Error>;

  messages?: Array<ColoZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse.Message>;

  /**
   * The exact parameters/timestamps the analytics service used to return data.
   */
  query?: ColoZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse.Query;

  /**
   * A breakdown of all dashboard analytics data by co-locations. This is limited to
   * Enterprise zones only.
   */
  result?: Array<ColoZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse.Result>;
...
export namespace ColoZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse {
  ...
  export interface Result {
     ...
     * parameters.
     */
    timeseries?: Array<Result.Timesery>;
