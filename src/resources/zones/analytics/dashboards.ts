...
import * as DashboardsAPI from 'cloudflare/resources/zones/analytics/dashboards';
...
export class Dashboards extends APIResource {
  ...
  zoneAnalyticsDeprecatedGetDashboard(
    ...
    return this._client.get(`/zones/${zoneIdentifier}/analytics/dashboard`, { query, ...options });
  }
}

export interface DashboardZoneAnalyticsDeprecatedGetDashboardResponse {
  errors?: Array<DashboardZoneAnalyticsDeprecatedGetDashboardResponse.Error>;

  messages?: Array<DashboardZoneAnalyticsDeprecatedGetDashboardResponse.Message>;

  /**
   * The exact parameters/timestamps the analytics service used to return data.
   */
  query?: DashboardZoneAnalyticsDeprecatedGetDashboardResponse.Query;

  /**
   * Totals and timeseries data.
   */
  result?: DashboardZoneAnalyticsDeprecatedGetDashboardResponse.Result;
