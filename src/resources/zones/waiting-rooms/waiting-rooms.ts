...
import * as PreviewsAPI from 'cloudflare/resources/zones/waiting-rooms/previews';
...
import * as StatusesAPI from 'cloudflare/resources/zones/waiting-rooms/statuses';
...
export class WaitingRooms extends APIResource {
  ...
  ): Core.APIPromise<SingleWaitingRoomResponse> {
    return this._client.get(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`, options);
  }
  ...
  update(
    ...
    return this._client.put(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`, { body, ...options });
  }
  ...
  delete(
    ...
    return this._client.delete(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`, options);
  }
  ...
  patch(
    zoneIdentifier: string,
    waitingRoomId: unknown,
    body: WaitingRoomPatchParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<SingleWaitingRoomResponse> {
    return this._client.patch(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}`, {
      body,
      ...options,
    });
  }
  ...
  waitingRoomCreateWaitingRoom(
    zoneIdentifier: string,
    body: WaitingRoomWaitingRoomCreateWaitingRoomParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<SingleWaitingRoomResponse> {
    return this._client.post(`/zones/${zoneIdentifier}/waiting_rooms`, { body, ...options });
  }
  ...
  waitingRoomListWaitingRooms(
    zoneIdentifier: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<WaitingRoomWaitingRoomListWaitingRoomsResponse> {
    return this._client.get(`/zones/${zoneIdentifier}/waiting_rooms`, options);
  }
}

export interface SingleWaitingRoomResponse {
  result?: SingleWaitingRoomResponse.Result;
}

export namespace SingleWaitingRoomResponse {
  export interface Result {
     ...
     */
    additional_routes?: Array<Result.AdditionalRoute>;
     ...
     */
    cookie_attributes?: Result.CookieAttributes;
...
export interface WaitingRoomDeleteResponse {
  result?: WaitingRoomDeleteResponse.Result;
}

export namespace WaitingRoomDeleteResponse {
  export interface Result {
    id?: unknown;
  }
}

export interface WaitingRoomWaitingRoomListWaitingRoomsResponse {
  errors?: Array<WaitingRoomWaitingRoomListWaitingRoomsResponse.Error>;

  messages?: Array<WaitingRoomWaitingRoomListWaitingRoomsResponse.Message>;

  result?: Array<WaitingRoomWaitingRoomListWaitingRoomsResponse.Result>;

  result_info?: WaitingRoomWaitingRoomListWaitingRoomsResponse.ResultInfo;
...
export namespace WaitingRoomWaitingRoomListWaitingRoomsResponse {
...
export interface WaitingRoomUpdateParams {
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomUpdateParams.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomUpdateParams.CookieAttributes;
...
export namespace WaitingRoomUpdateParams {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomPatchParams {
  /**
   * The host name to which the waiting room will be applied (no wildcards). Please
   * do not include the scheme (http:// or https://). The host and path combination
   * must be unique.
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomPatchParams.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomPatchParams.CookieAttributes;
...
export namespace WaitingRoomPatchParams {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export interface WaitingRoomWaitingRoomCreateWaitingRoomParams {
  /**
   * The host name to which the waiting room will be applied (no wildcards). Please
   * do not include the scheme (http:// or https://). The host and path combination
   * must be unique.
   ...
   * be unique to this and all other waiting rooms.
   */
  additional_routes?: Array<WaitingRoomWaitingRoomCreateWaitingRoomParams.AdditionalRoute>;

  /**
   * Configures cookie attributes for the waiting room cookie. This encrypted cookie
   * stores a user's status in the waiting room, such as queue position.
   */
  cookie_attributes?: WaitingRoomWaitingRoomCreateWaitingRoomParams.CookieAttributes;
...
export namespace WaitingRoomWaitingRoomCreateWaitingRoomParams {
  export interface AdditionalRoute {
    /**
     * The hostname to which this waiting room will be applied (no wildcards). The
     * hostname must be the primary domain, subdomain, or custom hostname (if using SSL
...
export namespace WaitingRooms {
  ...
  export import PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewResponse = PreviewsAPI.PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewResponse;
  export import PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewParams = PreviewsAPI.PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewParams;
