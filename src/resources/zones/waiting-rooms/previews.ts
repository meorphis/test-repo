...
export class Previews extends APIResource {
  ...
  waitingRoomCreateACustomWaitingRoomPagePreview(
    ...
    body: PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewResponse> {
    return this._client.post(`/zones/${zoneIdentifier}/waiting_rooms/preview`, { body, ...options });
  }
}

export interface PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewResponse {
  result?: PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewResponse.Result;
}

export namespace PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewResponse {
...
export interface PreviewWaitingRoomCreateACustomWaitingRoomPagePreviewParams {
  /**
