...
export class Statuses extends APIResource {
  ...
  waitingRoomGetWaitingRoomStatus(
    ...
    return this._client.get(`/zones/${zoneIdentifier}/waiting_rooms/${waitingRoomId}/status`, options);
  }
}

export interface StatusWaitingRoomGetWaitingRoomStatusResponse {
  result?: StatusWaitingRoomGetWaitingRoomStatusResponse.Result;
}

export namespace StatusWaitingRoomGetWaitingRoomStatusResponse {
