...
export class Tests extends APIResource {
  ...
  create(
    ...
    if (isRequestOptions(body)) {
      return this.create(zoneIdentifier, url, {}, body);
    }
    return this._client.post(`/zones/${zoneIdentifier}/speed_api/pages/${url}/tests`, { body, ...options });
  }
  ...
  retrieve(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<TestRetrieveResponse> {
    return this._client.get(
      `/zones/${zoneIdentifier}/speed_api/pages/${url}/tests/${testIdentifier}`,
      options,
    );
  }
  ...
  list(zoneIdentifier: string, url: string, options?: Core.RequestOptions): Core.APIPromise<TestListResponse>;
  list(
    zoneIdentifier: string,
    url: string,
    ...
    if (isRequestOptions(query)) {
      return this.list(zoneIdentifier, url, {}, query);
    }
    return this._client.get(`/zones/${zoneIdentifier}/speed_api/pages/${url}/tests`, { query, ...options });
  }
  ...
  delete(
    ...
    const { region } = params;
    return this._client.delete(`/zones/${zoneIdentifier}/speed_api/pages/${url}/tests`, {
      query: { region },
      ...options,
    });
  }
...
export interface TestCreateResponse {
  errors?: Array<TestCreateResponse.Error>;

  messages?: Array<TestCreateResponse.Message>;

  result?: TestCreateResponse.Result;
...
export namespace TestCreateResponse {
  ...
  export interface Result {
     ...
     */
    desktopReport?: Result.DesktopReport;

    /**
     * The Lighthouse report.
     */
    mobileReport?: Result.MobileReport;
...
export interface TestRetrieveResponse {
  errors?: Array<TestRetrieveResponse.Error>;

  messages?: Array<TestRetrieveResponse.Message>;

  result?: TestRetrieveResponse.Result;
...
export namespace TestRetrieveResponse {
  export interface Error {
    code: number;
...
export interface TestListResponse {
  ...
  result?: Array<TestListResponse.Result>;
...
export interface TestDeleteResponse {
  errors?: Array<TestDeleteResponse.Error>;

  messages?: Array<TestDeleteResponse.Message>;

  result?: TestDeleteResponse.Result;
...
export namespace TestDeleteResponse {
  export interface Error {
    code: number;
