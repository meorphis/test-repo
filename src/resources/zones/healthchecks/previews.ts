...
export class Previews extends APIResource {
  ...
  ): Core.APIPromise<HealthchecksAPI.HealthchecksSingleResponse> {
    return this._client.get(`/zones/${zoneIdentifier}/healthchecks/preview/${identifier}`, options);
  }
  ...
  delete(
    ...
    return this._client.delete(`/zones/${zoneIdentifier}/healthchecks/preview/${identifier}`, options);
  }
  ...
  healthChecksCreatePreviewHealthCheck(
    zoneIdentifier: string,
    body: PreviewHealthChecksCreatePreviewHealthCheckParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<HealthchecksAPI.HealthchecksSingleResponse> {
    return this._client.post(`/zones/${zoneIdentifier}/healthchecks/preview`, { body, ...options });
  }
}

export interface PreviewDeleteResponse {
  errors?: Array<PreviewDeleteResponse.Error>;

  messages?: Array<PreviewDeleteResponse.Message>;

  result?: PreviewDeleteResponse.Result;
...
export namespace PreviewDeleteResponse {
...
export interface PreviewHealthChecksCreatePreviewHealthCheckParams {
  /**
   ...
   */
  http_config?: PreviewHealthChecksCreatePreviewHealthCheckParams.HTTPConfig | null;
   ...
   */
  tcp_config?: PreviewHealthChecksCreatePreviewHealthCheckParams.TcpConfig | null;
...
export namespace PreviewHealthChecksCreatePreviewHealthCheckParams {
  /**
   * Parameters specific to an HTTP or HTTPS health check.
   */
