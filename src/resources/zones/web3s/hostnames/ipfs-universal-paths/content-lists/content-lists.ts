...
import * as ContentListsAPI from 'cloudflare/resources/zones/web3s/hostnames/ipfs-universal-paths/content-lists/content-lists';
...
export interface ContentListWeb3HostnameIpfsUniversalPathGatewayContentListDetailsResponse {
  errors?: Array<ContentListWeb3HostnameIpfsUniversalPathGatewayContentListDetailsResponse.Error>;

  messages?: Array<ContentListWeb3HostnameIpfsUniversalPathGatewayContentListDetailsResponse.Message>;

  result?: ContentListWeb3HostnameIpfsUniversalPathGatewayContentListDetailsResponse.Result;
...
export namespace ContentListWeb3HostnameIpfsUniversalPathGatewayContentListDetailsResponse {
...
export interface ContentListWeb3HostnameUpdateIpfsUniversalPathGatewayContentListResponse {
  errors?: Array<ContentListWeb3HostnameUpdateIpfsUniversalPathGatewayContentListResponse.Error>;

  messages?: Array<ContentListWeb3HostnameUpdateIpfsUniversalPathGatewayContentListResponse.Message>;

  result?: ContentListWeb3HostnameUpdateIpfsUniversalPathGatewayContentListResponse.Result;
...
export namespace ContentListWeb3HostnameUpdateIpfsUniversalPathGatewayContentListResponse {
  export interface Error {
    code: number;
