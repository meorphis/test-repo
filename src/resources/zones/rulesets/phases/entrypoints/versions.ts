...
export class Versions extends APIResource {
  ...
  zoneRulesetsListAZoneEntryPointRulesetSVersions(
    ...
    rulesetPhase:
      ...
      | 'magic_transit_managed',
    options?: Core.RequestOptions,
  ): Core.APIPromise<VersionZoneRulesetsListAZoneEntryPointRulesetSVersionsResponse> {
    return this._client.get(`/zones/${zoneId}/rulesets/phases/${rulesetPhase}/entrypoint/versions`, options);
  }
}
...
export interface VersionZoneRulesetsListAZoneEntryPointRulesetSVersionsResponse {
  errors?: unknown;

  /**
   * A list of warning messages.
   */
  messages?: Array<VersionZoneRulesetsListAZoneEntryPointRulesetSVersionsResponse.Message>;

  /**
   * A list of rulesets. The returned information will not include the rules in each
   * ruleset.
   */
  result?: Array<VersionZoneRulesetsListAZoneEntryPointRulesetSVersionsResponse.Result>;
...
export namespace VersionZoneRulesetsListAZoneEntryPointRulesetSVersionsResponse {
  /**
   * A message.
   */
  export interface Message {
