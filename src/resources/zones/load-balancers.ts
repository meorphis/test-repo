...
export class LoadBalancers extends APIResource {
  ...
  create(
    ...
    return this._client.post(`/zones/${identifier}/load_balancers`, { body, ...options });
  }
  ...
  retrieve(
    ...
    return this._client.get(`/zones/${identifier1}/load_balancers/${identifier}`, options);
  }
  ...
  update(
    ...
    return this._client.put(`/zones/${identifier1}/load_balancers/${identifier}`, { body, ...options });
  }

  /**
   * List configured load balancers.
   */
  list(identifier: string, options?: Core.RequestOptions): Core.APIPromise<LoadBalancerListResponse> {
    return this._client.get(`/zones/${identifier}/load_balancers`, options);
  }
  ...
  delete(
    ...
    return this._client.delete(`/zones/${identifier1}/load_balancers/${identifier}`, options);
  }
  ...
  patch(
    identifier1: string,
    identifier: string,
    body: LoadBalancerPatchParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<LoadBalancer> {
    return this._client.patch(`/zones/${identifier1}/load_balancers/${identifier}`, { body, ...options });
  }
}

export interface LoadBalancer {
  errors?: Array<LoadBalancer.Error>;

  messages?: Array<LoadBalancer.Message>;

  result?: LoadBalancer.Result;
...
export namespace LoadBalancer {
  ...
  export interface Result {
     ...
     */
    adaptive_routing?: Result.AdaptiveRouting;
     ...
     */
    location_strategy?: Result.LocationStrategy;
     ...
     *   open connections.
     */
    random_steering?: Result.RandomSteering;
     ...
     */
    session_affinity_attributes?: Result.SessionAffinityAttributes;
...
export interface LoadBalancerListResponse {
  errors?: Array<LoadBalancerListResponse.Error>;

  messages?: Array<LoadBalancerListResponse.Message>;

  result?: Array<LoadBalancerListResponse.Result>;

  result_info?: LoadBalancerListResponse.ResultInfo;
...
export interface LoadBalancerDeleteResponse {
  errors?: Array<LoadBalancerDeleteResponse.Error>;

  messages?: Array<LoadBalancerDeleteResponse.Message>;

  result?: LoadBalancerDeleteResponse.Result;
...
export namespace LoadBalancerDeleteResponse {
  export interface Error {
    code: number;
...
export interface LoadBalancerPatchParams {
  /**
   * Controls features that modify the routing of requests to pools and origins in
   * response to dynamic conditions, such as during the interval between active
   * health monitoring requests. For example, zero-downtime failover occurs
   ...
   * is retried once against this alternate origin.
   */
  adaptive_routing?: LoadBalancerPatchParams.AdaptiveRouting;
   ...
   * to learn how steering is affected.
   */
  location_strategy?: LoadBalancerPatchParams.LocationStrategy;
   ...
   *   open connections.
   */
  random_steering?: LoadBalancerPatchParams.RandomSteering;
   ...
   * execute.
   */
  rules?: Array<LoadBalancerPatchParams.Rule>;
   ...
   * Configures attributes for session affinity.
   */
  session_affinity_attributes?: LoadBalancerPatchParams.SessionAffinityAttributes;
...
export namespace LoadBalancerPatchParams {
  /**
   * Controls features that modify the routing of requests to pools and origins in
   * response to dynamic conditions, such as during the interval between active
   * health monitoring requests. For example, zero-downtime failover occurs
