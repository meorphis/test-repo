...
import * as SummariesAPI from 'cloudflare/resources/zones/spectrums/analytics/events/summaries';
...
export class Summaries extends APIResource {
  ...
  spectrumAnalyticsSummaryGetAnalyticsSummary(
    zone: string,
    query?: SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse>;
  spectrumAnalyticsSummaryGetAnalyticsSummary(
    zone: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse>;
  spectrumAnalyticsSummaryGetAnalyticsSummary(
    zone: string,
    query: SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse> {
    if (isRequestOptions(query)) {
      return this.spectrumAnalyticsSummaryGetAnalyticsSummary(zone, {}, query);
    }
    return this._client.get(`/zones/${zone}/spectrum/analytics/events/summary`, { query, ...options });
  }
}

export interface SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse {
  errors?: Array<SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse.Error>;

  messages?: Array<SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse.Message>;
...
export namespace SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryResponse {
...
export interface SummarySpectrumAnalyticsSummaryGetAnalyticsSummaryParams {
  /**
