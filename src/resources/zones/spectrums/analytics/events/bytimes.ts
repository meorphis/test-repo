...
import * as BytimesAPI from 'cloudflare/resources/zones/spectrums/analytics/events/bytimes';
...
export class Bytimes extends APIResource {
  ...
  spectrumAnalyticsByTimeGetAnalyticsByTime(
    zone: string,
    query?: BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse>;
  spectrumAnalyticsByTimeGetAnalyticsByTime(
    zone: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse>;
  spectrumAnalyticsByTimeGetAnalyticsByTime(
    zone: string,
    query: BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse> {
    if (isRequestOptions(query)) {
      return this.spectrumAnalyticsByTimeGetAnalyticsByTime(zone, {}, query);
    }
    return this._client.get(`/zones/${zone}/spectrum/analytics/events/bytime`, { query, ...options });
  }
}

export interface BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse {
  errors?: Array<BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse.Error>;

  messages?: Array<BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse.Message>;
...
export namespace BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeResponse {
...
export interface BytimeSpectrumAnalyticsByTimeGetAnalyticsByTimeParams {
  /**
