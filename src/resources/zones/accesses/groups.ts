...
export class Groups extends APIResource {
  ...
  create(
    ...
    return this._client.post(`/zones/${identifier}/access/groups`, { body, ...options });
  }
  ...
  retrieve(
    ...
    return this._client.get(`/zones/${identifier}/access/groups/${uuid}`, options);
  }
  ...
  update(
    ...
    return this._client.put(`/zones/${identifier}/access/groups/${uuid}`, { body, ...options });
  }

  /**
   * Lists all Access groups.
   */
  list(identifier: string, options?: Core.RequestOptions): Core.APIPromise<GroupListResponse> {
    return this._client.get(`/zones/${identifier}/access/groups`, options);
  }
  ...
  delete(
    ...
    return this._client.delete(`/zones/${identifier}/access/groups/${uuid}`, options);
  }
}

export interface GroupCreateResponse {
  errors?: Array<GroupCreateResponse.Error>;

  messages?: Array<GroupCreateResponse.Message>;

  result?: GroupCreateResponse.Result;
...
export interface GroupListResponse {
  errors?: Array<GroupListResponse.Error>;

  messages?: Array<GroupListResponse.Message>;

  result?: Array<GroupListResponse.Result>;

  result_info?: GroupListResponse.ResultInfo;
...
export interface GroupCreateParams {
   ...
   */
  include: Array<
    | GroupCreateParams.PajwohLqEmailRule
    | GroupCreateParams.PajwohLqEmailListRule
    | GroupCreateParams.PajwohLqDomainRule
    | GroupCreateParams.PajwohLqEveryoneRule
    | GroupCreateParams.PajwohLqIPRule
    | GroupCreateParams.PajwohLqIPListRule
    | GroupCreateParams.PajwohLqCertificateRule
    | GroupCreateParams.PajwohLqAccessGroupRule
    | GroupCreateParams.PajwohLqAzureGroupRule
    | GroupCreateParams.PajwohLqGitHubOrganizationRule
    | GroupCreateParams.PajwohLqGsuiteGroupRule
    | GroupCreateParams.PajwohLqOktaGroupRule
    | GroupCreateParams.PajwohLqSamlGroupRule
    | GroupCreateParams.PajwohLqServiceTokenRule
    | GroupCreateParams.PajwohLqAnyValidServiceTokenRule
    | GroupCreateParams.PajwohLqExternalEvaluationRule
    | GroupCreateParams.PajwohLqCountryRule
    | GroupCreateParams.PajwohLqAuthenticationMethodRule
    | GroupCreateParams.PajwohLqDevicePostureRule
  >;
