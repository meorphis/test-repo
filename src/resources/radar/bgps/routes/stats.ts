...
import * as StatsAPI from 'cloudflare/resources/radar/bgps/routes/stats';
...
export class Stats extends APIResource {
  ...
  list(
    ...
    return this._client.get('/radar/bgp/routes/stats', { query, ...options });
  }
}

export interface StatListResponse {
  result: StatListResponse.Result;
