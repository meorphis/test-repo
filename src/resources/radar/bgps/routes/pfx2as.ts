...
import * as Pfx2asAPI from 'cloudflare/resources/radar/bgps/routes/pfx2as';
...
export class Pfx2as extends APIResource {
  ...
  list(
    ...
    return this._client.get('/radar/bgp/routes/pfx2as', { query, ...options });
  }
}

export interface Pfx2aListResponse {
  result: Pfx2aListResponse.Result;
...
export namespace Pfx2aListResponse {
  export interface Result {
    ...
    prefix_origins: Array<Result.PrefixOrigin>;
  }
