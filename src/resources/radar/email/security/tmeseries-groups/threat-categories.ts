...
export class ThreatCategories extends APIResource {
  /**
  ...
  list(
    ...
    return this._client.get('/radar/email/security/timeseries_groups/threat_category', { query, ...options });
  }
}

export interface ThreatCategoryListResponse {
  result: ThreatCategoryListResponse.Result;
...
export namespace ThreatCategories {
