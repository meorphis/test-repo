...
export { MaliciousRetrieveResponse, MaliciousRetrieveParams, Malicious } from './malicious';
export { SpamRetrieveResponse, SpamRetrieveParams, Spam } from './spam';
export { SpfRetrieveResponse, SpfRetrieveParams, Spf } from './spf';
