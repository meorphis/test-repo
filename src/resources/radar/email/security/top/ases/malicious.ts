...
export class Malicious extends APIResource {
  ...
  retrieve(
    ...
    query?: MaliciousRetrieveParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<MaliciousRetrieveResponse>;
  retrieve(
    malicious: 'MALICIOUS' | 'NOT_MALICIOUS',
    options?: Core.RequestOptions,
  ): Core.APIPromise<MaliciousRetrieveResponse>;
  retrieve(
    malicious: 'MALICIOUS' | 'NOT_MALICIOUS',
    query: MaliciousRetrieveParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<MaliciousRetrieveResponse> {
    if (isRequestOptions(query)) {
      return this.retrieve(malicious, {}, query);
    }
    return this._client.get(`/radar/email/security/top/ases/malicious/${malicious}`, { query, ...options });
  }
}

export interface MaliciousRetrieveResponse {
  result: MaliciousRetrieveResponse.Result;

  success: boolean;
}

export namespace MaliciousRetrieveResponse {
...
export interface MaliciousRetrieveParams {
  /**
