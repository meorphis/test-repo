...
export class Verticals extends APIResource {
  /**
  ...
  list(
    ...
    return this._client.get('/radar/attacks/layer3/top/vertical', { query, ...options });
  }
}

export interface VerticalListResponse {
  result: VerticalListResponse.Result;
