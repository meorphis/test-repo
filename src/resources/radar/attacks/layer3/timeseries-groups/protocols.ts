...
export class Protocols extends APIResource {
  /**
  ...
  list(
    ...
    return this._client.get('/radar/attacks/layer3/timeseries_groups/protocol', { query, ...options });
  }
}

export interface ProtocolListResponse {
  result: ProtocolListResponse.Result;
