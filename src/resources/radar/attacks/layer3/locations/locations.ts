...
import * as OriginAPI from 'cloudflare/resources/radar/attacks/layer3/locations/origin';
import * as TargetAPI from 'cloudflare/resources/radar/attacks/layer3/locations/target';
