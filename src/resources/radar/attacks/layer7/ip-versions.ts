...
export class IPVersions extends APIResource {
  ...
  listTimeseriesGroups(
    query?: IPVersionListTimeseriesGroupsParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<IPVersionListTimeseriesGroupsResponse>;
  listTimeseriesGroups(options?: Core.RequestOptions): Core.APIPromise<IPVersionListTimeseriesGroupsResponse>;
  listTimeseriesGroups(
    query: IPVersionListTimeseriesGroupsParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<IPVersionListTimeseriesGroupsResponse> {
    if (isRequestOptions(query)) {
      return this.listTimeseriesGroups({}, query);
    }
    return this._client.get('/radar/attacks/layer7/timeseries_groups/ip_version', { query, ...options });
  }
}

export interface IPVersionListTimeseriesGroupsResponse {
  result: IPVersionListTimeseriesGroupsResponse.Result;

  success: boolean;
}

export namespace IPVersionListTimeseriesGroupsResponse {
...
export interface IPVersionListTimeseriesGroupsParams {
  /**
