...
export class BotClasses extends APIResource {
   ...
   * information.
   */
  list(query?: BotClassListParams, options?: Core.RequestOptions): Core.APIPromise<BotClassListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<BotClassListResponse>;
  list(
    query: BotClassListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<BotClassListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/summary/bot_class', { query, ...options });
  }
}

export interface BotClassListResponse {
  result: BotClassListResponse.Result;

  success: boolean;
}

export namespace BotClassListResponse {
...
export interface BotClassListParams {
  /**
