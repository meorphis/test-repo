...
export class HTTPProtocols extends APIResource {
   ...
   */
  list(
    query?: HTTPProtocolListParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<HTTPProtocolListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<HTTPProtocolListResponse>;
  list(
    query: HTTPProtocolListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<HTTPProtocolListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/summary/http_protocol', { query, ...options });
  }
}

export interface HTTPProtocolListResponse {
  result: HTTPProtocolListResponse.Result;

  success: boolean;
}

export namespace HTTPProtocolListResponse {
...
export interface HTTPProtocolListParams {
  /**
