...
export class DeviceTypes extends APIResource {
   ...
   */
  list(query?: DeviceTypeListParams, options?: Core.RequestOptions): Core.APIPromise<DeviceTypeListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<DeviceTypeListResponse>;
  list(
    query: DeviceTypeListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<DeviceTypeListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/summary/device_type', { query, ...options });
  }
}

export interface DeviceTypeListResponse {
  result: DeviceTypeListResponse.Result;

  success: boolean;
}

export namespace DeviceTypeListResponse {
