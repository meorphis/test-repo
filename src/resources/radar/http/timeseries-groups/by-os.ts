...
export class ByOs extends APIResource {
   ...
   * systems.
   */
  list(query?: ByOListParams, options?: Core.RequestOptions): Core.APIPromise<ByOListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<ByOListResponse>;
  list(
    query: ByOListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByOListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/timeseries_groups/os', { query, ...options });
  }
}

export interface ByOListResponse {
  result: ByOListResponse.Result;

  success: boolean;
}

export namespace ByOListResponse {
...
export interface ByOListParams {
  /**
