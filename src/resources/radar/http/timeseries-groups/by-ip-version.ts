...
export class ByIPVersion extends APIResource {
  /**
   * Get a time series of the percentage distribution of traffic per IP protocol
   * version.
   */
  list(
    query?: ByIPVersionListParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByIPVersionListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<ByIPVersionListResponse>;
  list(
    query: ByIPVersionListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByIPVersionListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/timeseries_groups/ip_version', { query, ...options });
  }
}

export interface ByIPVersionListResponse {
  result: ByIPVersionListResponse.Result;

  success: boolean;
}

export namespace ByIPVersionListResponse {
...
export interface ByIPVersionListParams {
  /**
