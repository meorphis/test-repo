...
export class ByBotClass extends APIResource {
  /**
   ...
   * information.
   */
  list(query?: ByBotClassListParams, options?: Core.RequestOptions): Core.APIPromise<ByBotClassListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<ByBotClassListResponse>;
  list(
    query: ByBotClassListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByBotClassListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/timeseries_groups/bot_class', { query, ...options });
  }
}

export interface ByBotClassListResponse {
  result: ByBotClassListResponse.Result;

  success: boolean;
}

export namespace ByBotClassListResponse {
...
export interface ByBotClassListParams {
  /**
