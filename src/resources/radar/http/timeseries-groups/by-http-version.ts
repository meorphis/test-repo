...
export class ByHTTPVersion extends APIResource {
  /**
   * Get a time series of the percentage distribution of traffic per HTTP protocol
   * version.
   */
  list(
    query?: ByHTTPVersionListParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByHTTPVersionListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<ByHTTPVersionListResponse>;
  list(
    query: ByHTTPVersionListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByHTTPVersionListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/timeseries_groups/http_version', { query, ...options });
  }
}

export interface ByHTTPVersionListResponse {
  result: ByHTTPVersionListResponse.Result;

  success: boolean;
}

export namespace ByHTTPVersionListResponse {
...
export interface ByHTTPVersionListParams {
  /**
...
export namespace ByHTTPVersion {
