...
export class ByTlsVersion extends APIResource {
  /**
   * Get a time series of the percentage distribution of traffic per TLS protocol
   * version.
   */
  list(
    query?: ByTlsVersionListParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByTlsVersionListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<ByTlsVersionListResponse>;
  list(
    query: ByTlsVersionListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ByTlsVersionListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/timeseries_groups/tls_version', { query, ...options });
  }
}

export interface ByTlsVersionListResponse {
  result: ByTlsVersionListResponse.Result;

  success: boolean;
}

export namespace ByTlsVersionListResponse {
...
export interface ByTlsVersionListParams {
  /**
