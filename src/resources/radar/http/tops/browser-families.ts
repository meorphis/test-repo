...
export class BrowserFamilies extends APIResource {
  /**
   * Get the top user agents aggregated in families by HTTP traffic. Values are a
   * percentage out of the total traffic.
   */
  list(
    query?: BrowserFamilyListParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<BrowserFamilyListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<BrowserFamilyListResponse>;
  list(
    query: BrowserFamilyListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<BrowserFamilyListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/top/browser_families', { query, ...options });
  }
}

export interface BrowserFamilyListResponse {
  result: BrowserFamilyListResponse.Result;

  success: boolean;
}

export namespace BrowserFamilyListResponse {
...
export interface BrowserFamilyListParams {
  /**
...
export namespace BrowserFamilies {
