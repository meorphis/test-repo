...
export class Browsers extends APIResource {
   ...
   * total traffic.
   */
  list(query?: BrowserListParams, options?: Core.RequestOptions): Core.APIPromise<BrowserListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<BrowserListResponse>;
  list(
    query: BrowserListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<BrowserListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/radar/http/top/browsers', { query, ...options });
  }
}

export interface BrowserListResponse {
  result: BrowserListResponse.Result;
