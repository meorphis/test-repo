...
export class HTTPVersions extends APIResource {
  ...
  retrieve(
    ...
    query?: HTTPVersionRetrieveParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<HTTPVersionRetrieveResponse>;
  retrieve(
    httpVersion: 'HTTPv1' | 'HTTPv2' | 'HTTPv3',
    options?: Core.RequestOptions,
  ): Core.APIPromise<HTTPVersionRetrieveResponse>;
  retrieve(
    httpVersion: 'HTTPv1' | 'HTTPv2' | 'HTTPv3',
    query: HTTPVersionRetrieveParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<HTTPVersionRetrieveResponse> {
    if (isRequestOptions(query)) {
      return this.retrieve(httpVersion, {}, query);
    }
    return this._client.get(`/radar/http/top/locations/http_version/${httpVersion}`, { query, ...options });
  }
}

export interface HTTPVersionRetrieveResponse {
  result: HTTPVersionRetrieveResponse.Result;

  success: boolean;
}

export namespace HTTPVersionRetrieveResponse {
...
export interface HTTPVersionRetrieveParams {
  /**
