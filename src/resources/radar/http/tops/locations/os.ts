...
export class Os extends APIResource {
  ...
  retrieve(
    ...
    query?: ORetrieveParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ORetrieveResponse>;
  retrieve(
    os: 'WINDOWS' | 'MACOSX' | 'IOS' | 'ANDROID' | 'CHROMEOS' | 'LINUX' | 'SMART_TV',
    options?: Core.RequestOptions,
  ): Core.APIPromise<ORetrieveResponse>;
  retrieve(
    os: 'WINDOWS' | 'MACOSX' | 'IOS' | 'ANDROID' | 'CHROMEOS' | 'LINUX' | 'SMART_TV',
    query: ORetrieveParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ORetrieveResponse> {
    if (isRequestOptions(query)) {
      return this.retrieve(os, {}, query);
    }
    return this._client.get(`/radar/http/top/locations/os/${os}`, { query, ...options });
  }
}

export interface ORetrieveResponse {
  result: ORetrieveResponse.Result;

  success: boolean;
}

export namespace ORetrieveResponse {
...
export interface ORetrieveParams {
  /**
