...
import * as BotClassesAPI from 'cloudflare/resources/radar/http/tops/locations/bot-classes';
import * as DeviceTypesAPI from 'cloudflare/resources/radar/http/tops/locations/device-types';
import * as HTTPProtocolsAPI from 'cloudflare/resources/radar/http/tops/locations/http-protocols';
import * as HTTPVersionsAPI from 'cloudflare/resources/radar/http/tops/locations/http-versions';
import * as IPVersionsAPI from 'cloudflare/resources/radar/http/tops/locations/ip-versions';
import * as OsAPI from 'cloudflare/resources/radar/http/tops/locations/os';
import * as TlsVersionsAPI from 'cloudflare/resources/radar/http/tops/locations/tls-versions';
...
export class Locations extends APIResource {
  ...
  list(
    ...
    return this._client.get('/radar/http/top/locations', { query, ...options });
  }
}
