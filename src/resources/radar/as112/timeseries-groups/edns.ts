...
export class Edns extends APIResource {
   ...
   */
  retrieve(query?: EdnRetrieveParams, options?: Core.RequestOptions): Core.APIPromise<EdnRetrieveResponse>;
  retrieve(options?: Core.RequestOptions): Core.APIPromise<EdnRetrieveResponse>;
  retrieve(
    ...
    return this._client.get('/radar/as112/timeseries_groups/edns', { query, ...options });
  }
}
