...
export class Dnssec extends APIResource {
   ...
   */
  retrieve(
    query?: DnssecRetrieveParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<DnssecRetrieveResponse>;
  retrieve(options?: Core.RequestOptions): Core.APIPromise<DnssecRetrieveResponse>;
  retrieve(
    query: DnssecRetrieveParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<DnssecRetrieveResponse> {
    if (isRequestOptions(query)) {
      return this.retrieve({}, query);
    }
    return this._client.get('/radar/as112/timeseries_groups/dnssec', { query, ...options });
  }
}
...
export interface DnssecRetrieveParams {
  /**
