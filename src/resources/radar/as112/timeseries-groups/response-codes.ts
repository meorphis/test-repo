...
export class ResponseCodes extends APIResource {
   ...
   */
  retrieve(
    query?: ResponseCodeRetrieveParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ResponseCodeRetrieveResponse>;
  retrieve(options?: Core.RequestOptions): Core.APIPromise<ResponseCodeRetrieveResponse>;
  retrieve(
    query: ResponseCodeRetrieveParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ResponseCodeRetrieveResponse> {
    if (isRequestOptions(query)) {
      return this.retrieve({}, query);
    }
    return this._client.get('/radar/as112/timeseries_groups/response_codes', { query, ...options });
  }
}

export interface ResponseCodeRetrieveResponse {
  result: ResponseCodeRetrieveResponse.Result;

  success: boolean;
}

export namespace ResponseCodeRetrieveResponse {
...
export interface ResponseCodeRetrieveParams {
  /**
